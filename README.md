...
TEST END TO END
PROM RESOURCE METRICS WORKING BUT NOT REQUEST METRICS (FORMAT CHANGE?)
REQ LOGGER POINTING AT 0.5.0 AND NOT PULLING, SWITCH TO 1.5.1, AS FOR OTHER IMAGES
ALSO NEED TO UPDATE SELDON CORE FROM 1.2.2 TO 1.5.0
